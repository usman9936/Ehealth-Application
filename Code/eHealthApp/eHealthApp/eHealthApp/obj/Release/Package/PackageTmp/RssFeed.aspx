<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="RssFeed.aspx.cs" Inherits="eHealthApp.RssFeed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="page-header">
        <h1>Read Parkinsons-Disease RSS Feed</h1>
    </div>
    <div id="v1">
                    ...
                    <div class="col-xs-12">
                       ...
                       <%-- <div class="col-lg-8 col-md-8 col-sm-6 col-xs-6"></div>
                        ...
                        <div>
                            ...
                            <asp:GridView ID="gvrss" EmptyDataText="NO DATA FOUND"  class="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False" ShowFooter="false" ShowHeaderWhenEmpty="true" ShowHeader="true" >
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
