<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ResearcherHome.aspx.cs" Inherits="eHealthApp.ResearcherHome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="v1">
        <asp:LinkButton Text="Check Parkinsons-Disease RSS Feed" ID="lnkAdd" CssClass="btn btn-info" OnClick="lnkAdd_Click" runat="server" />
                ...
                <div>
                    ...
                    <asp:GridView ID="gvdetail" EmptyDataText="NO DATA FOUND" AllowPaging="false" class="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False" ShowFooter="false" ShowHeaderWhenEmpty="true" ShowHeader="true" EnableViewState="true" OnSorting="gvdetail_Sorting" AllowSorting="True">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="User Data Files">
                                <ItemTemplate>
                                    <a href='<%# Eval("DataURL") %>'><i class="fa fa-file-excel-o"></i></a>
                                </ItemTemplate>
                            </asp:TemplateField>
